...
<!-- navigator 영역 -->
	...
	<div class="vf_sub_menu">
		<div style="width: 13%;"><a href="memberConfirmForm.do">회원정보수정</a></div>
		<div style="width: 12%;"><a href="#">배송지목록</a></div>
		<div style="width: 12%;"><a href="orderList.do">주문목록</a></div>
		<div style="width: 12%;"><a href="myReviewList.do">내가 쓴 리뷰</a></div>
