...
<!-- 리뷰 있을 때 -->
		...
		<table class="table" style="font-size:14px; margin:0px; padding:0px;">
			<tr align=center>
				...
				<td width="450" align="center">제 목</td>
	 ...
	 <div id="accordion">
		<c:forEach var="review" items="${list }">
			<div class="card-header" style="margin:0px; padding:0px;">
				<table id="list_${review.r_no}" class="table" style=" font-size:15px; margin:0px;">
					<tr style="padding:10px;">
					
						<td width="60" align="center">${review.r_no}</td>
						
						<td id="td_${review.r_no}" width="450" align="center">
						...
						<td width="150" align="center">${review.m_email}</td>
						
						<td width="150" align="center"><fmt:formatDate value="${review.r_writedate }" pattern="yyyy-MM-dd"/></td>
						
						<td width="80" align="center">${review.r_hit }</td>
